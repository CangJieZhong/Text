...
<script type="text/javascript"
	src="<%=request.getContextPath() %>/js/plugins/uploadify/jquery.uploadify.min.js"></script>
<script type="text/javascript"
		...
		<div class="row">
			...
			<div class="col-sm-9">
				<div class="panel panel-default">
					...
					<form class="form-horizontal" id="realAuthForm" method="post"
						action="realAuth_save.action" novalidate="novalidate">
						<fieldset>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input id="address" class="form-control" name="address"
										type="text" style="max-width: 100%; width: 500px;">
								</div>
							</div>
